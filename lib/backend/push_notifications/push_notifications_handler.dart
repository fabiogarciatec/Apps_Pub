...
final parametersBuilderMap =
  ...
  'Horimetros': ParameterData.none(),
  'login': ParameterData.none(),
  'BrindesItem': (data) async => ParameterData(
        allParams: {
          'foto': getParameter<String>(data, 'foto'),
          'nome': getParameter<String>(data, 'nome'),
          'pontos': getParameter<double>(data, 'pontos'),
          'skuProd': getParameter<String>(data, 'skuProd'),
        },
      ),
  'Perfil': ParameterData.none(),
  'AtualizaDados': ParameterData.none(),
  'Termo': ParameterData.none(),
  'CadastroUser': ParameterData.none(),
