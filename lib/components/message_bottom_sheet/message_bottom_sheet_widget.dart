...
import '/components/campanha_card_widget.dart';
                          ...
                          children: [
                            ...
                            Padding(
                              padding: EdgeInsetsDirectional.fromSTEB(
                                  0.0, 4.0, 0.0, 0.0),
                              child: Text(
                                'Abaixo estão suas novas mensagens.',
                                style: FlutterFlowTheme.of(context).bodySmall,
                              ),
                            ),
                            StreamBuilder<List<PushNotificationRecord>>(
                              ...
                              builder: (context, snapshot) {
                                ...
                                List<PushNotificationRecord>
                                    listViewPushNotificationRecordList =
                                    snapshot.data!;
                                return ListView.builder(
                                  ...
                                  itemCount:
                                      listViewPushNotificationRecordList.length,
