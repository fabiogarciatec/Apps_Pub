              ...
              child: Padding(
                ...
                child: InkWell(
                  ...
                  onTap: () async {
                    ...
                    _model.timer10sec = InstantTimer.periodic(
                      duration: Duration(milliseconds: 240000),
                      callback: (timer) async {
                        _model.timerLista = await RPListaDeBrindesCall.call();
                        setState(() {
                          FFAppState().JsonProdutos = getJsonField(
                            (_model.timerLista?.jsonBody ?? ''),
                            r'''$.produtos''',
                          );
                        });
                        _model.timer10sec?.cancel();
                      },
                      startImmediately: false,
                    );
