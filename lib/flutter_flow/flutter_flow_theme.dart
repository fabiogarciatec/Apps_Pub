...
class DarkModeTheme extends FlutterFlowTheme {
  ...
  late Color secondaryText = const Color(0xFFF3F3F3);
  late Color primaryBackground = const Color(0xFF0B0B0B);
  late Color secondaryBackground = const Color(0xFF121111);
  late Color accent1 = const Color(0xFFFFFFFF);
  late Color accent2 = const Color(0xFFAEAEAE);
  late Color accent3 = const Color(0xFF100F0F);
