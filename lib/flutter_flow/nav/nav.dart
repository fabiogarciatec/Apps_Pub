...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          name: 'Brindes',
          path: '/brindes',
          builder: (context, params) => BrindesWidget(),
        ),
        FFRoute(
          name: 'Extrato',
          path: '/extrato',
        ...
        FFRoute(
          name: 'BrindesItem',
          path: '/brindesItem',
          builder: (context, params) => BrindesItemWidget(
            foto: params.getParam('foto', ParamType.String),
            nome: params.getParam('nome', ParamType.String),
            pontos: params.getParam('pontos', ParamType.double),
            skuProd: params.getParam('skuProd', ParamType.String),
          ),
        ),
        FFRoute(
          name: 'Perfil',
        ...
        FFRoute(
          name: 'AtualizaDados',
          path: '/atualizaDados',
          builder: (context, params) => AtualizaDadosWidget(),
        ),
        FFRoute(
          name: 'Termo',
          path: '/termo',
          builder: (context, params) => TermoWidget(),
        ),
        FFRoute(
          name: 'CadastroUser',
          path: '/cadastroUser',
        ...
        FFRoute(
          name: 'Configurations',
          path: '/configurations',
          builder: (context, params) => ConfigurationsWidget(),
        ),
        FFRoute(
          name: 'AteLogo',
          path: '/ateLogo',
          builder: (context, params) => AteLogoWidget(),
        )
        ...
        pageBuilder: (context, state) {
          ...
          final child = appStateNotifier.loading
              ? Container(
                  ...
                  child: Center(
                    child: Image.asset(
                      'assets/images/Raizes_Banner.jpg',
                      width: 350.0,
                      fit: BoxFit.contain,
                    ),
                  ),
