...
import 'brindes_model.dart';
export 'brindes_model.dart';

class BrindesWidget extends StatefulWidget {
  const BrindesWidget({Key? key}) : super(key: key);

  @override
  _BrindesWidgetState createState() => _BrindesWidgetState();
}

class _BrindesWidgetState extends State<BrindesWidget> {
  late BrindesModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => BrindesModel());
  }
                        ...
                        Flexible(
                          child: Padding(
                            ...
                            child: Builder(
                              builder: (context) {
                                final listaBrindes =
                                    FFAppState().JsonProdutos.toList();
                                return ListView.builder(
                                  padding: EdgeInsets.zero,
                                  primary: false,
                                  shrinkWrap: true,
                                  scrollDirection: Axis.vertical,
                                  itemCount: listaBrindes.length,
                                  itemBuilder: (context, listaBrindesIndex) {
                                    final listaBrindesItem =
                                        listaBrindes[listaBrindesIndex];
