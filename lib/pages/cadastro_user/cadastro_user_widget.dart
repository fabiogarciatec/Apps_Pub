...
class CadastroUserWidget extends StatefulWidget {
  const CadastroUserWidget({Key? key}) : super(key: key);
                ...
                child: FFButtonWidget(
                  onPressed: _model.checkboxTermoValue == false
                      ...
                      : () async {
                          ...
                          if (RpAtualizarClienteCall.codigoResposta(
                                (_model.resulAtualizaCliente?.jsonBody ?? ''),
                              ) ==
                              FFAppState().cod100) {
                            await showDialog(
                              context: context,
                              builder: (alertDialogContext) {
                                return AlertDialog(
                                  title: Text('Dados o Usuário 👤 '),
                                  content: Text('Atualizados Com Sucesso!'),
                                  actions: [
                                    TextButton(
                                      onPressed: () =>
