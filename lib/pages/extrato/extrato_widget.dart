                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Padding(
                      ...
                      child: Text(
                        'Abaixo suas novas notificações.',
                              ...
                              children: [
                                ...
                                Padding(
                                  ...
                                  child: FutureBuilder<ApiCallResponse>(
                                    future: RPExtratoDePontuacaoCall.call(
                                    ...
                                    builder: (context, snapshot) {
                                      ...
                                      final listViewRPExtratoDePontuacaoResponse =
                                          snapshot.data!;
                                      return Builder(
                                        builder: (context) {
                                          final extratoPontos =
                                              RPExtratoDePontuacaoCall.extrato(
                                                    listViewRPExtratoDePontuacaoResponse
                                                        .jsonBody,
                                                  )?.toList() ??
                                                  [];
                                          return ListView.builder(
                                            ...
                                            shrinkWrap: true,
                                            scrollDirection: Axis.vertical,
                                            itemCount: extratoPontos.length,
                                            itemBuilder:
                                                (context, extratoPontosIndex) {
                                              final extratoPontosItem =
                                                  extratoPontos[
                                                      extratoPontosIndex];
                                              return Padding(
                                                padding: EdgeInsetsDirectional
                                                              ...
                                                              padding:
                                                                  EdgeInsetsDirectional
                                                                      .fromSTEB(
                                                                          ...
                                                                          0.0),
                                                              child: Text(
                                                                'Data Mov : ${valueOrDefault<String>(
                                                                  functions
                                                                      .dataBrasil(
                                                                          getJsonField(
                                                                    extratoPontosItem,
                                                              ...
                                                              Padding(
                                                                ...
                                                                child: Text(
                                                                  valueOrDefault<
                                                                    ...
                                                                    getJsonField(
                                                                              extratoPontosItem,
                                                                              r'''$.premio_identificador''',
                                                                            ) ==
                                                                            FFAppState().TRFROOTS
                                                                        ? 'Status da Transf :💰Executada '
                                                                        : null,
                                                                    '.',
                                                                  ),
                                                                  style: FlutterFlowTheme.of(
