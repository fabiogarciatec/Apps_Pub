                        ...
                        Expanded(
                          child: Padding(
                            padding: EdgeInsetsDirectional.fromSTEB(
                                0.0, 16.0, 0.0, 0.0),
                            child: TextFormField(
                              controller: _model.textDocumentoController,
                              readOnly: true,
                              obscureText: false,
                              decoration: InputDecoration(
                                labelText:
                                    'CPF ou CNPJ - Cotate o Administrador',
                              ...
                              validator: _model.textDocumentoControllerValidator
                                  .asValidator(context),
                            ),
                          ),
                        ),
                        ...
                        Expanded(
                          child: Padding(
                            ...
                            child: TextFormField(
                              ...
                              obscureText: false,
                              decoration: InputDecoration(
                                labelText: 'Email - Contate o Administrador',
                                labelStyle: FlutterFlowTheme.of(context)
                                    .labelMedium
                                    .override(
                                      fontFamily: 'Plus Jakarta Sans',
                    ...
                    if (RpAtualizarClienteCall.codigoResposta(
                      ...
                      setState(() {
                        FFAppState().jsonClientes =
                          ...
                          (_model.resultApiCliente?.jsonBody ?? ''),
                        );
                        FFAppState().dataNascimento =
                            RPConsultaClientesCall.datanascimento(
                          (_model.resultApiCliente?.jsonBody ?? ''),
                        ).toString();
                      });
